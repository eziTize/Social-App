...
//--getting all followers of current user so same users are not suggested
  getFollowing() async {
  ...
  buildUsersToFollow() {
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        List<UserResult> userResults = [];  // listing new users for following suggestions
...
//------- refresh indicator allows users to pull down feed to refresh
